...
import com.dawoud.elarabychallenge.presentation.BookMarkScreen.BookMarkFragmentDirections
...
class BookMarkAdapter(val  context: Context, val data:List<NewsModel>) : RecyclerView.Adapter<BookMarkAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action = BookMarkFragmentDirections.actionBookMarkFragmentToDetailsFragment(data.get(position))
